	...
	m_CurrentFrame{},m_FrameSec{framesSec}
{
	...
	MG_ASSERT(m_pRenderComponent != nullptr, "Cannot add RenderComponent to the components");
...
SDL_Rect AnimationComponent::GetCell() const
{
	...
	MG_ASSERT(isOwnerNotNullptr, "Cannot get owner!!");
	...
	MG_ASSERT(isTransformNotNullptr, "Cannot get transform!!");
